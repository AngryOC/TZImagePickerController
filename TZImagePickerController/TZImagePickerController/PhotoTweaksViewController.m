...
- (void)resetOriginImage:(UIImage *)image{
     _image = image;
    [self.photoView resetOriginImage:image];
}
...
- (void)setupSubviews
{
    ...
    [cancelBtn setTitle:cancelBtnTitleStr forState:UIControlStateNormal];
    ...
    [cropBtn setTitle:doneBtnTitleStr forState:UIControlStateNormal];
